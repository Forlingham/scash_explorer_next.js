...
export default async function WhaleWatcherPage({ searchParams }: WhaleWatcherPageProps & { searchParams: Promise<any> }) {
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <div className="flex items-center gap-4">
            <DatePicker selectedDate={date} basePath="/whale-watcher" placeholder={t('common.selectDate')} paramName="date" />
          </div>
        </CardHeader>
        <CardContent>
