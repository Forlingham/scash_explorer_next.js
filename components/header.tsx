...
export async function Header() {
  ...
  const navItems = [
    ...
    { href: '/dap/20/1', label: t('nav.dap') },
    { href: '/whale-watcher', label: t('nav.richList') },
    { href: `/info`, label: "API" }
      ...
      <div className="w-full lg:container lg:mx-auto px-4">
        <div className="flex h-16 items-center justify-between gap-4">
          ...
          <Link href="/" className="flex items-center gap-3">
            ...
            <span className="hidden font-bold text-xl lg:inline-block bg-gradient-to-r from-primary to-primary-light bg-clip-text text-transparent">
              {t('home.title')}
            </span>
          </Link>
